...
*`txtred="${nps}\e[0;31m${npe}" # Red t`*

*`xtgrn="${nps}\e[0;32m${npe}" # Green `*
...
*`PS1="${bldyel}\uparse_git_branch$${txtrst} " `*
...
*`ls /usr/local/var/log/ redis.log rsyslogd.log S`*

*`at Oct 26 21:56:12 CST 2024 ospost@MacPro.local:/Users/ospost `*
...
*`Sat Oct 26 21:56:55 CST 2024 ospost@MacPro.local:/Users/ospost ospost $`*
